					...
					'fields' => apply_filters(
						...
						array(
							...
							array(
								...
								'type'    => 'number',
								'title'   => esc_html__( 'From Right', 'th-all-in-one-woo-cart' ),
								'default' => 29,
								'min'     => 1,
								'max'     => 400,
								'suffix'  => 'px',
							...
							array(
								...
								'type'    => 'number',
								'title'   => esc_html__( 'From Left', 'th-all-in-one-woo-cart' ),
								'default' => 29,
								'min'     => 1,
								'max'     => 400,
								'suffix'  => 'px',
							 ...
							 array(
								...
								'type'    => 'number',
								'title'   => esc_html__( 'From Bottom', 'th-all-in-one-woo-cart' ),
								'default' => 36,
								'min'     => 1,
								'max'     => 400,
								'suffix'  => 'px',
					...
					'fields' => apply_filters(
						'taiowc_related_product_setting_fields', array(
							...
							array(
								...
								'type'    => 'text',
								'title'   => esc_html__( 'Heading', 'th-all-in-one-woo-cart' ),
								'default' => esc_html__( 'Your Cart', 'th-all-in-one-woo-cart' ),
							),
							...
							array(
								...
								'desc'   => esc_html__( 'Empty Cart Button URL- Add URL Where you want to redirect user in case of empty cart. By Default users will be redirected to Shop Page.', 'th-all-in-one-woo-cart' ),
								'default' =>'',
							),
	...
	taiowc_main()->taiowc_add_setting(
			...
			'taiowc-cart_style_settings_section', array(
				 ...
				 array(
				  ...
				  array(
					'title'  => esc_html__( 'Milestones 1', 'th-all-in-one-woo-cart' ),
					'fields' => apply_filters(
						'taiowc_milestones_bar_fields', array(
							array(
				  ...
				  array(
					'title'  => esc_html__( 'Milestones 2', 'th-all-in-one-woo-cart' ),
					'fields' => apply_filters(
						'taiowc_milestones_bar_fields', array(
				  ...
				  array(
					'title'  => esc_html__( 'Milestones 3', 'th-all-in-one-woo-cart' ),
					'fields' => apply_filters(
						'taiowc_milestones_bar_fields', array(
