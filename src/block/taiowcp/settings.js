...
const Thicon2 = () => (
    <span className="th-icon th-icon-Shopping_icons-11"></span>
    );
const Thicon3 = () => (
        <span className="th-icon th-icon-Shopping_icons-16"></span>
        );
const Thicon4 = () => (
        <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-01"></span>
        );
const Thicon5 = () => (
            <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-11"></span>
            );
const Thicon6 = () => (
                <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-23"></span>
                ); 
const Thicon7 = () => (
               <span className="th-icon th-icon-Shopping_icons-01"></span>
                );    
    ...
    return (
        ...
        <InsSettingHeader value={ tab }
           ...
           <PanelBody
             ...
             <div className='th-component-group-label th-cart-icon'>
                            <label className='th-label'>{ __( 'Select Icon', 'taiowc' )}</label>
                            <ToogleGroupControl
										value={ attributes.cartIcon }
								        onChange={ cartIcon => setAttributes({ cartIcon }) }
										options={[
											{
												icon: <Thicon1/>,
    ...
    <PanelBody
             ...
             <ResponsiveControl
                        ...
                        <ControlPanelControl
						   ...
						   >
							<div className='th-component-group-label count-position'>
                            <label className='th-label'>{ __( 'Count Position', 'taiowc' )}</label>
                            <ToogleGroupControl
										value={ attributes.countPosition }
								        onChange={ countPosition => setAttributes({ countPosition }) }
										options={[
											{
							...
							/>  
                            <ResponsiveControl
								label={ __( 'Count Size', 'vayu-blocks' ) }
							     >	
								<UnitChooser
                            ...
                            <ResponsiveControl
								label={ __( 'Count Font Size', 'vayu-blocks' ) }
							     >	
								<UnitChooser
