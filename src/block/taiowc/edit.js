	...
	setAttributes }) {
      ...
      const ThiconStyle = ({ cartIconAttr }) => {
        if (cartIconAttr === 'icon-1') {
          ...
          return <span className="th-icon th-icon-Shopping_icons-11"></span>;
        }else if (cartIconAttr === 'icon-3') {
          return  <span className="th-icon th-icon-Shopping_icons-16"></span>;
        }else if (cartIconAttr === 'icon-4') {
          return   <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-01"></span>;
        }else if (cartIconAttr === 'icon-5') {
          return   <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-11"></span>;
        }else if (cartIconAttr === 'icon-6') {
          return  <span className="th-icon th-icon-Shopping-Bag-Cart-Icons-23"></span>;
