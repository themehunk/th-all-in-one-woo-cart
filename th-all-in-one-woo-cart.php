...
if ( ! function_exists( 'taiowc_plugin_meta_links' ) ){
  ...
  function taiowc_plugin_meta_links($links, $file){
    ...
    $doc_link = '<a target="_blank" href="https://themehunk.com/docs/th-all-in-one-woo-cart/" title="' . __('Documentation', 'taiowc') . '"><span class="dashicons  dashicons-search"></span>' . __('Documentation', 'taiowc') . '</a>';

    $support_link = '<a target="_blank" href="https://themehunk.com/th-all-in-one-woo-cart/" title="' . __('Support', 'taiowc') . '"><span class="dashicons  dashicons-admin-users"></span>' . __('Support', 'taiowc') . '</a>';

    $pro_link = '<a target="_blank" href="https://themehunk.com/th-all-in-one-woo-cart/" title="' . __('Premium Version', 'taiowc') . '"><span class="dashicons  dashicons-cart"></span>' . __('Premium Version', 'taiowc') . '</a>';
